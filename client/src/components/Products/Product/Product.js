    ...
    return (
        <Card className={classes.card}>
            ...
            <div className={classes.details}>
                <Typography variant="body2" color="textSecondary">{product.tags.map((tag) => `#${tag} `)}</Typography>
            </div>
            <CardContent>
                <Typography className={classes.title} variant="h5" gutterBottom>{product.message}</Typography>
            </CardContent>
